...
ggplot(federal_account_trend, aes(x = date, y=open_today)) + geom_point()
```
...
Now we want to go and see where this money went. In order to do this I want to analyze the data
